...
Architecture: [784, 512, 1024, 10]
  Dense_0: (512, 784)   = 401,408 params  ← INPUT
  Dense_1: (1024, 512)  = 524,288 params  ← HIDDEN (MORE params than input)
...
RESULTS_DIR = PROJECT_ROOT / "results" / "wide_hidden_ablation_v2"
RESULTS_DIR.mkdir(parents=True, exist_ok=True)

# Architecture
HIDDEN_DIMS = (512, 1024)
# Shapes as stored by Flax: (out_features, in_features)
INPUT_SHAPE  = (512, 784)    # Dense_0: 401,408 params
HIDDEN_SHAPE = (1024, 512)   # Dense_1: 524,288 params (MORE than input)
...
def main():
    ...
    print("SUMMARY")
    print("=" * 60)
    print(f"Architecture: [784, 512, 1024, 10]")
